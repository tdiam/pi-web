...
export function getModelKey(model: Pick<RpcModelInfo, "provider" | "id">): string {
	return `${model.provider}/${model.id}`;
}

export function upsertModel(models: RpcModelInfo[], model: RpcModelInfo): RpcModelInfo[] {
...
export function filterModels(models: RpcModelInfo[], query: string): RpcModelInfo[] {
